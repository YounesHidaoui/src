                    ...
                    <div class="sm:ltr:mr-auto sm:rtl:ml-auto">
                        ...
                        >
                            <div class="relative">
                                <input
                                    type="text"
                                    class="w-96 peer form-input bg-gray-100 placeholder:tracking-widest ltr:pl-9 ltr:pr-9 rtl:pr-9 rtl:pl-9 sm:bg-transparent ltr:sm:pr-4 rtl:sm:pl-4"
                                    placeholder="Cherch dossier..."
                                />
                            ...
                            <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8">
                                ...
                                >
                                    ...
                                    <span class="absolute top-0 flex h-3 w-3 ltr:right-0 rtl:left-0">
                                        ...
                                        ></span>
                                        <span class="relative inline-flex h-[6px] w-[6px] rounded-full bg-amber-800"></span>
                                    </span>
                                </button>
